...
import { User, Mail, Phone, Building2, Globe, Tag, Send, ArrowLeft } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto space-y-6 animate-fade-in">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-slate-500 text-sm">Fill in the details to create a new lead in your CRM.</p>
        </div>
      </div>
